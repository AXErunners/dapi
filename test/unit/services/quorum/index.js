...
// const ZmqClient = require('../../../../lib/api/axecore/ZmqClient');
//
// const { expect } = chai;
//
// describe('services/quorum/index', () => {
//   const config = require('../../../../lib/config');
//   config.axecore.rpc.port = 12345;
//   proxyquire('../../../../lib/api/axecore/rpc', { '../../../config': config });
//   require('../../../../lib/api/axecore/rpc');
...
//     });
//     it('should not quorum call start function without axecoreZmqClient', () => {
//       expect(() => quorumService.start())
// .to.throw('Cannot read property \'topics\' of undefined');
//     });
//     it('should quorum call start function with axecoreZmqClient', () => {
...
//       const res = quorumService.getQuorumHash();
//       await expect(res)
// .to.be.rejectedWith('Axe JSON-RPC: Request Error: connect ECONNREFUSED 127.0.0.1:12345');
//     });
