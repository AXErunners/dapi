...
const axeDriveFixture = require('../../../mocks/axeDriveFixture');
...
describe('sendRawTransition', () => {
  ...
  describe('#factory', () => {
    it('should return a function', () => {
      const sendRawTransaction = sendRawTransitionFactory(coreAPIFixture, axeDriveFixture);
  ...
  before(() => {
    ...
    addSTPacketSpy = sinon.spy(axeDriveFixture, 'addSTPacket');
  });
  ...
  it('should return a transaction ID', async () => {
    ...
    const sendRawTransition = sendRawTransitionFactory(coreAPIFixture, axeDriveFixture);
