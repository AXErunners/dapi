...
const AbstractAxeDriveAdapter = require('./AbstractAxeDriveAdapter');
const RPCError = require('../../rpcServer/RPCError');

class AxeDriveAdapter extends AbstractAxeDriveAdapter {
  /**
   * @param options
  ...
  /**
   * Makes request to AxeDrive and handles response
   * @param {string} method
   * @param {Object} params
   * @return {Promise<*>}
   */
  ...
  /**
   * Add State Transition Packet to AxeDrive storage
  ...
  /**
   * Fetch DAP Contract from AxeDrive State View
...
module.exports = AxeDriveAdapter;
