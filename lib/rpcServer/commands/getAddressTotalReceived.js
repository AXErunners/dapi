...
const getAddressTotalReceivedFactory = (coreAPI) => {
  /**
   * Layer 1 endpoint
   * Returns total amount of haks received by address
 ...
 *      description: Get the total amount of haks received by an address
 *      tags:
 *        - L1
 *      responses:
 *        200:
 *          description: Successful response. Promise (number) indicating the number of haks received by the address.
 *      requestBody:
 *        content:
 *          application/json:
 *            schema:
