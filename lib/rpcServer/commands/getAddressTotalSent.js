...
const getAddressTotalSentFactory = (coreAPI) => {
  /**
   * Layer 1 endpoint
   * Returns total amount of haks sent by the address
 ...
 *      description: Get the total amount of haks sent by an address
 *      tags:
 *        - L1
 *      responses:
 *        200:
 *          description: Successful response. Promise (number) indicating the number of haks sent by the address.
 *      requestBody:
 *        content:
 *          application/json:
 *            schema:
